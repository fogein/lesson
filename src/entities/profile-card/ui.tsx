...
export const ProfileCard = () => {
  return (
    <Box className='w-[259px] h-[358px] relative z-[1] overflow-hidden'>
    ...
    <div className='p-[40px_11px_38px_22px] flex flex-col items-center'>
      ...
      <span className='font-[400] ml-[-8px] text-[12px] leading-[110%]'>I have experince 1 year UI/UX Design</span>
      <div className='flex items-center justify-between w-full mt-[30px]'>
        <div className='flex flex-col gap-[10px] ml-[-4px]'>
        ...
        <div className='flex flex-col gap-[10px] mr-[28px] mt-[-1px]'>
      ...
      <div className='flex items-center justify-between w-full mt-[27px]'>
        <div className='flex items-center gap-[2.94px] ml-[-2px]'>
          <IconButton className='w-[32px] h-[32px]' icon={<BiBookmarkAlt fill='#fff' className='-[#fff]' size={20} />} rounded />
          <span className='text-[#070928] text-opacity-[0.75] font-400 text-[12px] leading-[110%]'>Saved</span>
        </div>
        <div className='flex items-center gap-[6.86px] mr-[5px]'>
          <IconButton className='w-[32px] h-[32px]' icon={<BiKey fill='#fff' className='-[#fff]' size={20} />} rounded />
