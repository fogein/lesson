...
export const Accordion: FC<AccordionType> = (props) => {
  const {titleName, children, active, id, onClick, className} = props;


  return (
   <div className={className}>
     <div className='flex items-center justify-between'>
      <span className='text-[#070928] font-[500] text-[14px] leading-[16px]'>{titleName}</span>
    ...
    <div
        id={id}
        className={`border-0 ${
          !active ? 'overflow-hidden' : 'overflow-y-auto'
